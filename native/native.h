...
#define ERR_DISMATCH_TYPE 9
#define ERR_NULL_REQUIRED 10
#define ERR_UNSUPPORT_THRIFT_TYPE 11
#define ERR_UNKNOWN_FIELD 12
#define ERR_DISMATCH_TYPE2 13
#define ERR_DECODE_BASE64 14
#define ERR_STATE 15
...
ssize_t unquote(const char *sp, ssize_t nb, char *dp, int64_t *ep, uint64_t flags);
