...
const (
    ...
    _entry__i64toa = 3696
    _entry__u64toa = 3824
    _entry__j2t_fsm_exec = 39216
    _entry__j2t_number = 34192
    ...
    _entry__j2t_field_vm = 37536
    _entry__tb_write_default_or_empty = 31264
    _entry__j2t_write_unset_fields = 33360
    _entry__j2t_find_field_key = 36480
    _entry__lspace = 80
    _entry__quote = 5136
