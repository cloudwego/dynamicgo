...
func (p *SimpleMethodArgs) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetReq() {
		return out, fmt.Errorf("No req in SimpleMethodArgs")
	}
...
func (p *SimpleMethodResult) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetSuccess() {
		return out, fmt.Errorf("No req in SimpleMethodResult")
	}
...
func (p *PartialSimpleMethodArgs) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetReq() {
		return out, fmt.Errorf("No req in PartialSimpleMethodArgs")
	}
	return proto.Marshal(p.Req)
}
...
func (p *PartialSimpleMethodResult) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetSuccess() {
		return out, fmt.Errorf("No req in PartialSimpleMethodResult")
	}
	return proto.Marshal(p.Success)
}
...
func (p *NestingMethodArgs) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetReq() {
		return out, fmt.Errorf("No req in NestingMethodArgs")
	}
	return proto.Marshal(p.Req)
}
...
func (p *NestingMethodResult) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetSuccess() {
		return out, fmt.Errorf("No req in NestingMethodResult")
	}
	return proto.Marshal(p.Success)
}
...
func (p *PartialNestingMethodArgs) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetReq() {
		return out, fmt.Errorf("No req in PartialNestingMethodArgs")
	}
	return proto.Marshal(p.Req)
}
...
func (p *PartialNestingMethodResult) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetSuccess() {
		return out, fmt.Errorf("No req in PartialNestingMethodResult")
	}
	return proto.Marshal(p.Success)
}
...
func (p *Nesting2MethodArgs) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetReq() {
		return out, fmt.Errorf("No req in Nesting2MethodArgs")
	}
	return proto.Marshal(p.Req)
}
...
func (p *Nesting2MethodResult) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetSuccess() {
		return out, fmt.Errorf("No req in Nesting2MethodResult")
	}
	return proto.Marshal(p.Success)
}
