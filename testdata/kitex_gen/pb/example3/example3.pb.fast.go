...
func (x *InnerBase2) fastReadField10(buf []byte, _type int8) (offset int, err error) {
	offset, err = fastpb.ReadList(buf, _type,
		func(buf []byte, _type int8) (n int, err error) {
			...
			x.SetInt32 = append(x.SetInt32, v)
			return offset, err
		})
	return offset, err
}
...
func (x *InnerBase2) fastReadField22(buf []byte, _type int8) (offset int, err error) {
	x.Sfixed32, offset, err = fastpb.ReadSfixed32(buf, _type)
	return offset, err
}

func (x *InnerBase2) fastReadField23(buf []byte, _type int8) (offset int, err error) {
	x.Fixed64, offset, err = fastpb.ReadFixed64(buf, _type)
	return offset, err
}

func (x *InnerBase2) fastReadField24(buf []byte, _type int8) (offset int, err error) {
	x.Sint32, offset, err = fastpb.ReadSint32(buf, _type)
	return offset, err
}

func (x *InnerBase2) fastReadField25(buf []byte, _type int8) (offset int, err error) {
	x.Sint64, offset, err = fastpb.ReadSint64(buf, _type)
	return offset, err
}

func (x *InnerBase2) fastReadField26(buf []byte, _type int8) (offset int, err error) {
	offset, err = fastpb.ReadList(buf, _type,
		func(buf []byte, _type int8) (n int, err error) {
			var v int64
...
func (x *InnerBase2) fastReadField27(buf []byte, _type int8) (offset int, err error) {
	offset, err = fastpb.ReadList(buf, _type,
		func(buf []byte, _type int8) (n int, err error) {
			var v int32
...
func (x *InnerBase2) fastReadField28(buf []byte, _type int8) (offset int, err error) {
	offset, err = fastpb.ReadList(buf, _type,
		func(buf []byte, _type int8) (n int, err error) {
			var v int32
...
func (x *InnerBase2) fastReadField29(buf []byte, _type int8) (offset int, err error) {
	offset, err = fastpb.ReadList(buf, _type,
		func(buf []byte, _type int8) (n int, err error) {
			var v uint64
...
func (x *InnerBase2) fastReadField30(buf []byte, _type int8) (offset int, err error) {
	if x.MapInt64Sfixed64 == nil {
		x.MapInt64Sfixed64 = make(map[int64]int64)
	}
	var key int64
	var value int64
	offset, err = fastpb.ReadMapEntry(buf, _type,
	...
	x.MapInt64Sfixed64[key] = value
	return offset, nil
}

func (x *InnerBase2) fastReadField31(buf []byte, _type int8) (offset int, err error) {
	if x.MapStringFixed32 == nil {
		x.MapStringFixed32 = make(map[string]uint32)
	}
	var key string
	var value uint32
	offset, err = fastpb.ReadMapEntry(buf, _type,
...
func (x *InnerBase2) fastWriteField5(buf []byte) (offset int) {
	...
	offset += fastpb.WriteInt64(buf[offset:], 5, x.GetInt64())
	return offset
}
...
func (x *InnerBase2) fastWriteField10(buf []byte) (offset int) {
	...
	offset += fastpb.WriteListPacked(buf[offset:], 10, len(x.GetSetInt32()),
		func(buf []byte, numTagOrKey, numIdxOrVal int32) int {
			offset := 0
			offset += fastpb.WriteInt32(buf[offset:], numTagOrKey, x.GetSetInt32()[numIdxOrVal])
			return offset
		})
	return offset
}
...
func (x *InnerBase2) fastWriteField22(buf []byte) (offset int) {
	if x.Sfixed32 == 0 {
		return offset
	}
	offset += fastpb.WriteSfixed32(buf[offset:], 22, x.GetSfixed32())
	return offset
}

func (x *InnerBase2) fastWriteField23(buf []byte) (offset int) {
	if x.Fixed64 == 0 {
		return offset
	}
	offset += fastpb.WriteFixed64(buf[offset:], 23, x.GetFixed64())
	return offset
}

func (x *InnerBase2) fastWriteField24(buf []byte) (offset int) {
	if x.Sint32 == 0 {
		return offset
	}
	offset += fastpb.WriteSint32(buf[offset:], 24, x.GetSint32())
	return offset
}

func (x *InnerBase2) fastWriteField25(buf []byte) (offset int) {
	if x.Sint64 == 0 {
		return offset
	}
	offset += fastpb.WriteSint64(buf[offset:], 25, x.GetSint64())
	return offset
}

func (x *InnerBase2) fastWriteField26(buf []byte) (offset int) {
	if len(x.ListSInt64) == 0 {
		return offset
	}
	offset += fastpb.WriteListPacked(buf[offset:], 26, len(x.GetListSInt64()),
		func(buf []byte, numTagOrKey, numIdxOrVal int32) int {
			offset := 0
...
func (x *InnerBase2) fastWriteField27(buf []byte) (offset int) {
	if len(x.ListSInt32) == 0 {
		return offset
	}
	offset += fastpb.WriteListPacked(buf[offset:], 27, len(x.GetListSInt32()),
		func(buf []byte, numTagOrKey, numIdxOrVal int32) int {
			offset := 0
...
func (x *InnerBase2) fastWriteField28(buf []byte) (offset int) {
	if len(x.ListSfixed32) == 0 {
		return offset
	}
	offset += fastpb.WriteListPacked(buf[offset:], 28, len(x.GetListSfixed32()),
		func(buf []byte, numTagOrKey, numIdxOrVal int32) int {
			offset := 0
...
func (x *InnerBase2) fastWriteField29(buf []byte) (offset int) {
	if len(x.ListFixed64) == 0 {
		return offset
	}
	offset += fastpb.WriteListPacked(buf[offset:], 29, len(x.GetListFixed64()),
		func(buf []byte, numTagOrKey, numIdxOrVal int32) int {
			offset := 0
...
func (x *InnerBase2) fastWriteField30(buf []byte) (offset int) {
	if x.MapInt64Sfixed64 == nil {
		return offset
	}
	for k, v := range x.GetMapInt64Sfixed64() {
		offset += fastpb.WriteMapEntry(buf[offset:], 30,
			func(buf []byte, numTagOrKey, numIdxOrVal int32) int {
				offset := 0
				offset += fastpb.WriteInt64(buf[offset:], numTagOrKey, k)
...
func (x *InnerBase2) fastWriteField31(buf []byte) (offset int) {
	if x.MapStringFixed32 == nil {
		return offset
	}
	for k, v := range x.GetMapStringFixed32() {
...
func (x *InnerBase2) sizeField5() (n int) {
	...
	n += fastpb.SizeInt64(5, x.GetInt64())
	return n
}
...
func (x *InnerBase2) sizeField10() (n int) {
	...
	n += fastpb.SizeListPacked(10, len(x.GetSetInt32()),
		func(numTagOrKey, numIdxOrVal int32) int {
			n := 0
			n += fastpb.SizeInt32(numTagOrKey, x.GetSetInt32()[numIdxOrVal])
			return n
		})
	return n
}
...
func (x *InnerBase2) sizeField22() (n int) {
	if x.Sfixed32 == 0 {
		return n
	}
	n += fastpb.SizeSfixed32(22, x.GetSfixed32())
	return n
}

func (x *InnerBase2) sizeField23() (n int) {
	if x.Fixed64 == 0 {
		return n
	}
	n += fastpb.SizeFixed64(23, x.GetFixed64())
	return n
}

func (x *InnerBase2) sizeField24() (n int) {
	if x.Sint32 == 0 {
		return n
	}
	n += fastpb.SizeSint32(24, x.GetSint32())
	return n
}

func (x *InnerBase2) sizeField25() (n int) {
	if x.Sint64 == 0 {
		return n
	}
	n += fastpb.SizeSint64(25, x.GetSint64())
	return n
}

func (x *InnerBase2) sizeField26() (n int) {
	if len(x.ListSInt64) == 0 {
		return n
	}
	n += fastpb.SizeListPacked(26, len(x.GetListSInt64()),
		func(numTagOrKey, numIdxOrVal int32) int {
			n := 0
...
func (x *InnerBase2) sizeField27() (n int) {
	if len(x.ListSInt32) == 0 {
		return n
	}
	n += fastpb.SizeListPacked(27, len(x.GetListSInt32()),
		func(numTagOrKey, numIdxOrVal int32) int {
			n := 0
...
func (x *InnerBase2) sizeField28() (n int) {
	if len(x.ListSfixed32) == 0 {
		return n
	}
	n += fastpb.SizeListPacked(28, len(x.GetListSfixed32()),
		func(numTagOrKey, numIdxOrVal int32) int {
			n := 0
...
func (x *InnerBase2) sizeField29() (n int) {
	if len(x.ListFixed64) == 0 {
		return n
	}
	n += fastpb.SizeListPacked(29, len(x.GetListFixed64()),
		func(numTagOrKey, numIdxOrVal int32) int {
			n := 0
...
func (x *InnerBase2) sizeField30() (n int) {
	if x.MapInt64Sfixed64 == nil {
		return n
	}
	for k, v := range x.GetMapInt64Sfixed64() {
		n += fastpb.SizeMapEntry(30,
			func(numTagOrKey, numIdxOrVal int32) int {
				n := 0
				n += fastpb.SizeInt64(numTagOrKey, k)
...
func (x *InnerBase2) sizeField31() (n int) {
	if x.MapStringFixed32 == nil {
		return n
	}
	for k, v := range x.GetMapStringFixed32() {
